...
var USER_AGENT = 'VideoAPIcloud/1.1.0 (NodeJS)';
...
module.exports = {
  ...
  submit: function(configContent, apiKey, callback) {
    ...
    var reqOptions = {
      hostname: VideoAPIcloudURL.hostname,
      port: VideoAPIcloudURL.port || (VideoAPIcloudURL.protocol == 'https:' ? 443 : 80),
      path: '/v1/job',
      method: 'POST',
      auth: apiKey+':',
      headers: {
    ...
    var req = (VideoAPIcloudURL.protocol == 'https:' ? https : http).request(reqOptions, function(res) {
